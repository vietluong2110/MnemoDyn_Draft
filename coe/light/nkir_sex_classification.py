...
from nkir_dataset import NKIR_Dataset, load_nkir_file_list
...
def parse_args():
    ...
    parser.add_argument("--exp", default='NKIR_Sex_Classification_450', help="Adjusted in code: Experiment foler name")
...
def main():
    ...
    all_files, label_map_str = load_nkir_file_list(
        '/mnt/sourav/HBN_dtseries/',
        '/mnt/vhluong/nkir_paths.csv',
        'sex',
        450
    )
    ...
    files_0 = [f for f in all_files if label_map_str[f] == 0]
    files_1 = [f for f in all_files if label_map_str[f] == 1]
    ...
    balanced_labels = [label_map_str[f] for f in balanced_files]
