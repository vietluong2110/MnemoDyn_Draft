...
class ABIDEaModule:
    ...
    def setup(self):
        ...
        self.train_dataset = ABIDE_Dataset(self.data_dir, self.train_files, self.label_map, self.time_step, 
                                    self.interpol_method, self.one_channel, self.subset, self.dim_D, 
                                    self.target_length, self.num_parcels, self.label_column)
        self.test_dataset = ABIDE_Dataset(self.data_dir, self.test_files, self.label_map, self.time_step, 
                                    self.interpol_method, self.one_channel, self.subset, self.dim_D, 
                                    self.target_length, self.num_parcels, self.label_column)
...
def load_abide_file_list(
    ...
    required = {"relative_path", "label_num"}
