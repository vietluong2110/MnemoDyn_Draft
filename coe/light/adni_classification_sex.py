...
import logging
from main_pe import LitORionModelOptimized
...
def main():
	...
	# pos_files = [f for f, (lab, _, _) in label_map_str.items() if lab == 'M']
	# neg_files = [f for f, (lab, _, _) in label_map_str.items() if lab == 'F']
	...
	train_dataset = ADNI_Dataset(
		...
		label_column   = 'subjectSex'        # <-- this makes __getitem__ return grp_idx
	)
